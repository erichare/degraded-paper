...
\begin{figure}
\includegraphics[width=.5\textwidth]{degraded-paper_files/figure-latex/roughcordist-1} \caption{Empirical CDFs of the Roughness Correlation compared to the CCF for known matches and known non-matches. It can be seen that the distribution of each feature for the known non-matches is quite symmetric, while the distribution for each feature for the known matches is skewed left.}\label{fig:roughcordist}
\end{figure}
...
Study & False Negative & False Positive & True Negative & True Positive \\ 
  \hline
Hamby252\_Hamby252 & 0.38\% & 0.02\% & 97.56\% & 2.04\% \\ 
  Hamby252\_Hamby44 & 0.45\% & 0.05\% & 98.3\% & 1.19\% \\ 
  Hamby44\_Hamby44 & 0.88\% & 0.09\% & 97.68\% & 1.35\% \\ 
   \hline
\end{tabular}
...
Prediction $\backslash$ Actual & Hamby252\_Hamby252 & Hamby252\_Hamby44 & Hamby44\_Hamby44 \\ 
  \hline
Hamby252\_Hamby252 & 09.93\% & 08.47\% & 011.3\% \\ 
  Hamby252\_Hamby44 & 81.24\% & 80.82\% & 78.27\% \\ 
  Hamby44\_Hamby44 & 08.83\% & 010.7\% & 10.43\% \\ 
   \hline
\end{tabular}
